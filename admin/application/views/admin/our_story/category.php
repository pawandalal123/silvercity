...
$this->load->view('admin/parts/header', ['title' => 'Our Story', 'add' => $add]); ?>
    <!-- Main content -->
...
<script type="text/javascript"> 
    ...
    $("form[name='add_category']").submit(function(e) {    
        ...
        $.ajax({
            url: '<?php echo base_url('ourstory/add')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
   ...
   $("form[name='update_category']").submit(function(e) {    
        var formData = new FormData($(this)[0]);
        $.ajax({
            url: '<?php echo base_url('ourstory/update_category')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
  ...
  $(".category").change(function() {    
     ...
     //alert(categoryID);    
      $.ajax({
           type: "GET",
           url: '<?php echo base_url('ourstory/change_category_status')?>'+'/'+categoryID,
           dataType: "json",
           success: function (data) {
             $('body,html').animate({ scrollTop: 0 }, 200);
                    $.bootstrapGrowl(data.msg,{
      ...
      $('.delete_category').click(function(){
           ...
           //alert(categoryID);
             $.ajax({
              type: "GET",
              url: '<?php echo base_url('ourstory/delete_category')?>'+'/'+categoryID,
              dataType: "json",
              success: function(data)
              {
                $('body,html').animate({ scrollTop: 0 }, 200);
