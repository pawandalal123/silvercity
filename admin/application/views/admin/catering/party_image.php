        ...
        <form name="add_category" class="add_category" action="" method="POST">
          <div class="modal-body">
             ...
             <div class="form-group ">
                ...
                <label> Image Label<span style="color: red">*</span></label>
                 <input type="text" class="form-control" name="image_label" id="image_label">
...
<script type="text/javascript"> 
    ...
    $("form[name='add_category']").submit(function(e) {    
        ...
        $.ajax({
            url: '<?php echo base_url('catering/add_party_images')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
