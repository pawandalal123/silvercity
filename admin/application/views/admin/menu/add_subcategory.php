...
$this->load->view('admin/parts/header', ['title' => 'Add Menu', 'add' => $add]); ?>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="btn-group"><span data-placement="top" data-toggle="tooltip" title="add"><a href="<?php echo base_url('menu/menu_content') ?>" class="btn btn-primary btnPlus dvshwalert MR5">Back</a></span></div>
        </div>
             </div>
            <!-- /.box-header -->
            <div class="box-body">
           ...
           <div class="row">
           <form name="add_subcategory" class="add_subcategory" action="<?php echo base_url('menu/add_subcategory')?>" method="POST" enctype="multipart/form-data">
