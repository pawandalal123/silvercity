...
$this->load->view('admin/parts/header', ['title' => 'Add Work', 'add' => $add]); ?>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="btn-group"><span data-placement="top" data-toggle="tooltip" title="add"><a href="<?php echo base_url('work') ?>" class="btn btn-primary btnPlus dvshwalert MR5">Back</a></span></div>
        </div>
             </div>
            <!-- /.box-header -->
            <div class="box-body">
     ...
     <form name="add_class" class="add_class" action="" method="POST">
                               ...
                               <div class="row">
                                            ...
                                            <label class="control-label col-md-3 MT5 text-right"> Image</label>
                                             ...
                                             <?php 
                                              if(!empty($work[0]->IMAGE)):
                                             ?>
                                                <img src="<?php echo base_url('uploads/image/'. $work[0]->IMAGE);?>" height="50px" width="50px">
                                           <?php 
                                              endif;
                                           ?>
                                           </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <label class="control-label col-md-3 MT5 text-right"> Hower Image</label>
                                             <div class="form-group col-md-5">
                                             <input type="file" class="form-control" name="HOWER_IMAGE" id="recipient-name">
                                             <?php 
                                              if(!empty($work[0]->HOWER_IMAGE)):
                                             ?>
                                                <img src="<?php echo base_url('uploads/image/'. $work[0]->HOWER_IMAGE);?>" height="50px" width="50px">
                                           <?php 
                                              endif;
                                           ?>
                                           </div>
                                     ...
                                     <div class="row">
                                      ...
                                      <div class="form-group col-md-5">
                                        ...
                                        <input class="form-control" id="groupname" type="text" name="TITLE" value="<?php echo !empty($work[0]->TITLE) ? $work[0]->TITLE : '';?>">
                                      </div>
                                    </div>
                                      ...
                                      <div class="form-group col-md-5">
                                        ...
                                        <?php echo $this->ckeditor->editor("DESCRIPTION",$work[0]->DESCRIPTION);?>
                                      </div>
                                    </div>
                ...
                <button type="submit" class="btn btn-primary MR5"><?php echo !empty($work) ? 'Update' : 'Submit' ?></button>
               </div>
                                  </div>
                                </div>
                              </form>
...
<script type="text/javascript"> 
    ...
    $(document).ready(function(){
     ...
     for (instance in CKEDITOR.instances) {
        ...
        $.ajax({
            url: '<?php echo base_url('work/add')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
            success: function (data) {
              ...
              if(data.success==true){
                setTimeout(function(){
                  window.location.href='<?php echo base_url('work')?>';
              }, 1000);
            }
         },
            cache: false,
