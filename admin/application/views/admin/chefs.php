...
$this->load->view('admin/parts/header', ['title' => 'Add Chefs', 'add' => $add]); ?>
    <!-- Main content -->
                                       ...
                                       <td> 
                                                ...
                                                <td>
                                                  <span id="<?php echo $cat->ID;?>">
                                                    <a href="javascript:;" class="delete_chefs" id="<?php echo $cat->ID;?>"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal-dialog ">
                                ...
                                <div class="form-group">
                                     ...
                                     <input type="text" name="NAME" class="form-control" value="<?php echo $cat->NAME; ?>">
                                      ...
                                      <textarea class="form-control" name="DESCRIPTION"><?php echo $cat->DESCRIPTION; ?></textarea>
...
<script type="text/javascript"> 
    ...
    $("form[name='add_category']").submit(function(e) {    
        ...
        $.ajax({
            url: '<?php echo base_url('restaurant/add_chefs')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
  ...
  $(".category").change(function() {    
     ...
     //alert(categoryID);    
      ...
      $('.delete_chefs').click(function(){
            var categoryID  = $(this).attr('id');
           //alert(categoryID);
             $.ajax({
              type: "GET",
              url: '<?php echo base_url('restaurant/delete_chefs')?>'+'/'+categoryID,
              dataType: "json",
              success: function(data)
              {
                $('body,html').animate({ scrollTop: 0 }, 200);
