...
<script type="text/javascript"> 
    ...
    $("form[name='add_tag']").submit(function(e) {    
        ...
        $.ajax({
            url: '<?php echo base_url('gallery/add_gallery_tag')?>',
            type: "POST",
            data: formData,
            dataType: "json",
            async: false,
     ...
     $("form[name='update_tag']").submit(function(e) {    
      var formData = new FormData($(this)[0]);
      $.ajax({
        url: '<?php echo base_url('gallery/update_gallery_tag')?>',
        type: "POST",
        data: formData,
        dataType: "json",
        async: false,
...
$('.delete_tag').click(function(){
      ...
      $('.delete_teacher').click(function(){
        ...
        // alert(teachersID); die;
           ...
           $.ajax({
            type: "GET",
          url: '<?php echo base_url('gallery/delete_gallery_tag')?>'+'/'+teachersID,
            dataType: "json",
            success: function(data)
            {
             $.bootstrapGrowl(data.msg,{
