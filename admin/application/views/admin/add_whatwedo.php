...
$this->load->view('admin/parts/header', ['title' => 'Add What We Do', 'add' => $add]); ?>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="btn-group"><span data-placement="top" data-toggle="tooltip" title="add"><a href="<?php echo base_url('whatwedo') ?>" class="btn btn-primary btnPlus dvshwalert MR5">Back</a></span></div>
        </div>
             </div>
            <!-- /.box-header -->
            <div class="box-body">
     ...
     <form name="add_class" class="add_class" action="" method="POST">
                                 <input type="hidden" name="ID" value="<?php echo $whatwedo[0]->ID;?>">
                               ...
                               <div class="row">
                                            ...
                                            <label class="control-label col-md-3 MT5 text-right"> Image</label>
                                             ...
                                             <?php 
                                              if(!empty($whatwedo[0]->IMAGE)):
                                             ?>
                                                <img src="<?php echo base_url('uploads/image/'. $whatwedo[0]->IMAGE);?>" height="50px" width="50px">
                                           <?php 
                                              endif;
                                           ?>
                                           </div>
                                     ...
                                     <div class="row">
                                      ...
                                      <div class="form-group col-md-5">
                                        ...
                                        <input class="form-control" id="groupname" type="text" name="TITLE" value="<?php echo !empty($whatwedo[0]->TITLE) ? $whatwedo[0]->TITLE : '';?>">
                                      </div>
                                    </div>
                                      ...
                                      <div class="form-group col-md-5">
                                        ...
                                        <?php echo $this->ckeditor->editor("DESCRIPTION",$whatwedo[0]->DESCRIPTION);?>
                                      </div>
                                    </div>
                ...
                <button type="submit" class="btn btn-primary MR5"><?php echo !empty($whatwedo) ? 'Update' : 'Submit' ?></button>
               </div>
                                  </div>
                                </div>
                              </form>
        ...
        $.ajax({
            ...
            success: function (data) {
              ...
              if(data.success==true){
                setTimeout(function(){
                  window.location.href='<?php echo base_url('whatwedo')?>';
              }, 1000);
            }
         },
            cache: false,
